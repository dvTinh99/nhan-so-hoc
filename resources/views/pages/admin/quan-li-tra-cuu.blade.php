                    ...
                    <tbody>
                        @foreach ($seeks as $key => $seek)
                            ...
                            <tr>
                                ...
                                <td><span class="text-danger"> {{ $seek->status }} </span></td>
                                <td>
                                ...
                                <td><svg style="width: 20px;color: red;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
